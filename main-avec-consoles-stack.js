...
async function main() {
    ...
    const url = new URL(
        ...
        "http://127.0.0.1:8000/Documents/splat-main"
    );
    ...
    const resize = () => {
        console.log("point 2 a cause du call de fonction en bas");
    ...
    worker.onmessage = (e) => {
        if (e.data.buffer) {
          ...
          link.href = URL.createObjectURL(blob);
            ...
            console.log("point 4 on a tout lu le data!"); //ce bout la ressemble au paint??
    ...
    const frame = (now) => {
        console.log("point 3 a cause du call de fonction en dessous");
        let inv = invert4(viewMatrix);
    ...
    while (true) {
        console.log("reader is reading! 1");
...
} //quand il fini de tout lire, il retourne a frame a cause de requestanimationframe!
